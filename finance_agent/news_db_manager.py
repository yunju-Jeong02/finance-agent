...
class NewsDatabaseManager:
    ...
    # ----------------- 뉴스 검색 (DB 우선, 없으면 크롤링) -----------------
    def search_news(self, keywords: Optional[Union[str, List[str]]] = None, date: Optional[str] = None, limit: int = 5) -> List[Dict]:
        conditions, params = [], {}
        ...
        try:
            ...
            print(f"[NewsDatabaseManager] with_content 실패: {e}")
