...
그럼 아래 사용자 질문에 대해 clarification_needed와 clarification_question을 작성해 주세요.
==============
{user_query}
"""

sql_generation_prompt = """
한국어 질문을 krx_stockprice 테이블에 대한 MYSQL 쿼리로 변환해주세요.
...
다음 사용자 질문을 SQL 쿼리로 변환해주세요.
================
{query}
"""

sql_refinement_prompt = """
다음 SQL 쿼리에서 오류가 발생했습니다. 오류를 수정하여 올바른 SQL 쿼리를 작성해주세요. SQL 쿼리 출력은 ```sql로 시작하고, 마지막에 ```로 끝나야 합니다.
